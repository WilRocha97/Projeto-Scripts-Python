...
def run():
    ...
    _escreve_header_csv('CNPJ;NOME;NÚMERO DA NF;NÚMERO DA DPS;CHAVE DE ACESSO;COMPETÊNCIA;DATA DE EMISSÃO;'
                        ...
                        'REGIME ESPECIAL DE TRIBUTAÇÃO;EMITENTE EMAIL;CNPJ TOMADOR;RAZÃO SOCIAL TOMADOR;INSCRIÇÃO MUNICIPAL TOMADOR;'
                        'TRIBUTAÇÃO ISSQN;PAÍS DA PRESTAÇÃO DO SERVIÇO;MUNICÍPIO DE INCIDÊNCIA;TIPO DE IMUNIDADE;SUSPENSÃO DO ISSQN;'
                        'NÚMERO DO PROCESSO DE SUSPENSÃO;BENEFÍCIO MUNICIPAL;VALOR DO SERVIÇO;DESCONTO INCONDICIONADO;TOTAL DE DEDUÇÕES/REDUÇÕES;'
                        'TOTAL DO BENEFÍCIO MUNICIPAL;BASE DE CÁLCULO;ALÍQUOTA;VALOR DO ISSQN;RETENÇÃO;VERSÃO DA APLICAÇÃO;'
                        'AMBIENTE GERADOR;SITUAÇÃO DA NFS-E;PAÍS;MUNICÍPIO;CÓD. DE TRIBUTAÇÃO NACIONAL;ITEM DA NBS CORRESP. AO SERVIÇO PRESTADO;'
                        'DESCRIÇÃO DO SERVIÇO;NOME DO EVENTO;DATA DE INÍCIO;DATA DO FIM;CÓDIGO DE IDENTIFICAÇÃO;Nº DOC. RESPONSABILIDADE TÉCNICA;'
                        'DOC. REFERÊNCIA;INFOS COMPLEMENTARES;SITUAÇÃO TRIB. PIS/COFINS;BASE DE CÁLCULO PIS/COFINS;PIS-ALÍQUOTA;PIS-VALOR IMPOSTO;'
                        'COFINS-ALÍQUOTA;COFINS-VALOR IMPOSTO;TIPO RETENÇÃO PIS/COFINS;VALOR RETIDO IRRF;VALOR RETIDO CSLL;VALOR RETIDO CP;OPÇÃO')

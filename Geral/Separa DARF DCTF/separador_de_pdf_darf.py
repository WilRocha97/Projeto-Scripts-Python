...
def cria_pdf(page, matchtexto_nome, matchtexto_cnpj, matchtexto_codigo, prevtexto_nome, prevtexto_cnpj, prevtexto_codigo, pdf, pagina1, pagina2, andamento):
    with fitz.open() as new_pdf:
        ...
        text = '{} - {} - {} - DARF.pdf'.format(nome, cnpj, codigo)
...
def separa():
    # Abrir o pdf
    with fitz.open(r'PDFs\DARF Dominio 0561.pdf') as pdf:
            ...
            try:
                ...
                # Se for diferente ele separa a página
                    ...
                    if paginas > 0:
                        ...
                        prevpagina, prevtexto_nome, prevtexto_cnpj, prevtexto_codigo = cria_pdf(page, matchtexto_nome, matchtexto_cnpj,

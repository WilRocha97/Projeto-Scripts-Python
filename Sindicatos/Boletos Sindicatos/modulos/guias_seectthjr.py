...
def login(driver, cnpj, senha):
    # entra no site
    driver.get('http://www.mirah.com.br/localizacnpj.aspx?CodigoEntidade=020144043968&Contribuicao=Assistencial')
...
def run(empresa):
    ...
    print('70 - SEECTTHJR - Sindicato dos Empregados e Trabalhadores em Turismo e Hospitalidade de Jundiaí e Região')

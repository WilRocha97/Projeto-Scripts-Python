...
def login(driver, cnpj, senha):
    # entra no site
    driver.get('http://boletos.sistemasgarbiminformatica.com.br/boletos/login;jsessionid=M0FXnAa2w8jrjx2BEvOZAdi4To8PPpS2Yk7NRgnG.node47421-garbimboletos?0')
...
def run(empresa):
    ...
    print('133 - SINDCOMERCIARIOS - Sindicato dos Comerciários de Sorocaba e Região')

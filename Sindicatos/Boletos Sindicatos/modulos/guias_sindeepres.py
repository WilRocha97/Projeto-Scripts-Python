...
def login(driver, cnpj, senha):
    # entra no site
    driver.get('https://boletos.sindeepres.org.br/')
...
def run(empresa):
    ...
    print('16 - SINDEEPRES - Sindicato dos Empregados em Empresas de Prestação de Serviços a Terceiros, Colocação e Administração de Mão de Obra, '

...
def login(driver, cnpj, senha):
    # entra no site
    driver.get('https://sindiesp.gersin.com.br/public/consulta')
...
def run(empresa):
    ...
    print('38 - SINDIESP - Sindicato dos Trabalhadores nas Empresas de Internet Manutenção e Cursos de Informática do Estado de São Paulo')

...
def login(driver, cnpj, senha):
    # entra no site
    driver.get('https://sindvestjundiai.gersin.com.br/public/consulta')
...
def run(empresa):
    ...
    print('25 - SINDVEST JUNDIAÍ - Sindicato dos Trabalhadores nas Indústrias de Calçados e Vestuário em Geral de Jundiaí e Região')

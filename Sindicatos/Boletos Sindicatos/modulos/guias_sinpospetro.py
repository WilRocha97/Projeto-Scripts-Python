...
def login(driver, cnpj, senha):
    # entra no site
    driver.get('https://sweb.diretasistemas.com.br/prosindweb/index.php')
...
def run(empresa):
    ...
    print('19 - SIMPOSPETRO - Sindicato dos Empregados em Postos de Serviços de Combustíveis e Derivados de Petróleo de Campinas e Região')

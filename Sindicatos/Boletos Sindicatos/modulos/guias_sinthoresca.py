...
def login(driver, cnpj, senha):
    # entra no site
    driver.get('https://portal.afsys.com.br/sinthoresca/login')
...
def run(empresa):
    ...
    print('148 - SINTHORESCA - Sindicato dos Trabalhadores em Hotéis, Bares e Restaurantes de Águas de Lindóia e Região')
